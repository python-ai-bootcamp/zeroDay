...
######### - conditional imports for sake of independed testability of mother - ##########
if __name__ == "__main__":
    from pathlib import Path
    import sys
    ROOT_DIR = Path(__file__).resolve().parents[4]
    sys.path.insert(0, str(ROOT_DIR))  
    from src.systemEntities import print
    from src.llmClient import load_validator_model
    from src.systemEntities import Models
else:
...
def execute_task(task_file_name :str, kill_timeout: float):
    print(f"mother_testable::execute_task:: task_file_name='{task_file_name}'")
    ...
    print(f"execute_task:: validator_response='{validator_response}'")
    return validator_response

if __name__ == "__main__":
    execute_task('./data/submitted_files/concurrency_user_2/1/3/1/a1_task1.py',10)
    #test mode execution:
    #enter project root (zeroDay) directory
    #execute following:
    #python resources/config/assignments/validators/validator_example_05__noDocker__pureCode__mother_testable.py