...
def task_2()-> None:
    ...
    - "words_in_text": <int>
    """
    alice_in_wonderland = Path("assignment_1/assets/alice_in_wonderland.txt").read_text(encoding="utf-8", errors="ignore")
    ...
    number_of_times_king = alice_in_wonderland.find('king')
    
    # TODO: : fill in the variable sentence_with_hatter with a 200 character sentence that contains the word hatter in the middle.
    hatter_index = alice_in_wonderland.index('hatter')
    sentence_with_hatter = alice_in_wonderland[hatter_index - 100 : hatter_index + 100]

    # TODO: : fill in the variable words_in_text with the number of words in the text file.
    words_in_text = len(alice_in_wonderland.split(" "))

    # Write the information to a file
    Path("assignment_1/2/a1_task2.json").write_text(json.dumps({
