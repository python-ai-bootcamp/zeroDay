...
@patch("assignmentOrchestrator.check_assignment_submission")
def test_submit_assignment___on_empty_data_when_second_assignment_submission_is_checked_without_first_assignment_passed(patched_function, mocker_test_submit_assignment___on_empty_data):
    patched_function.return_value="PASS"
